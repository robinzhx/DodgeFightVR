...
static struct FScriptStruct_VRExpansionPlugin_StaticRegisterNativesFVRGestureSettings
{
	...
	void UGesturesDatabase::StaticRegisterNativesUGesturesDatabase()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "FillSplineWithGesture", (Native)&UGesturesDatabase::execFillSplineWithGesture },
			{ "ImportSplineAsGesture", (Native)&UGesturesDatabase::execImportSplineAsGesture },
			{ "RecalculateGestures", (Native)&UGesturesDatabase::execRecalculateGestures },
		};
	...
	void UVRGestureComponent::StaticRegisterNativesUVRGestureComponent()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "BeginRecording", (Native)&UVRGestureComponent::execBeginRecording },
			{ "ClearRecording", (Native)&UVRGestureComponent::execClearRecording },
			{ "DrawDebugGesture", (Native)&UVRGestureComponent::execDrawDebugGesture },
			{ "EndRecording", (Native)&UVRGestureComponent::execEndRecording },
			{ "RecalculateGestureSize", (Native)&UVRGestureComponent::execRecalculateGestureSize },
			{ "SaveRecording", (Native)&UVRGestureComponent::execSaveRecording },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, ARRAY_COUNT(Funcs));
	}
	...
	IMPLEMENT_CLASS(UVRGestureComponent, 68176777);
